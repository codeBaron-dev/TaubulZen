...
@Composable
fun SecondOnboardSliderRoot(skipToLastPager: () -> Unit) {
    SecondOnboardSlider(skipToLastPager = skipToLastPager)
}

@Composable
fun SecondOnboardSlider(skipToLastPager: () -> Unit) {
    Scaffold(
        bottomBar = {
            SharedPageBottomBarView(
                header = stringResource(Res.string.second_pager_heading),
                subHeader = stringResource(Res.string.second_pager_sub_heading),
